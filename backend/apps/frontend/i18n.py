...
BOOKING_I18N: dict[str, dict[str, str]] = {
    "en": {
        ...
        "agree_terms_required": "Please check the box to agree to the Terms and Conditions.",
    ...
    "de": {
        ...
        "agree_terms_required": "Bitte aktivieren Sie das Kontrollkästchen für die AGB.",
