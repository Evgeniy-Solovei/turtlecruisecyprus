...
BOOKING_I18N: dict[str, dict[str, str]] = {
    "en": {
        ...
        "too_many_seats": "You can only book up to {n} seats for this date.",
        "adults": "Adults",
        "children": "Children",
    ...
    "de": {
        ...
        "too_many_seats": "Für dieses Datum können Sie maximal {n} Plätze buchen.",
        "adults": "Erwachsene",
        "children": "Kinder",
        ...
        "start_new_booking": "Neue Buchung starten",
